...
- LLM 기반 시스템에서 "결정론 필수 영역"과 "비결정론 허용 영역" 구분이 핵심. 이벤트 소싱이 "기록 시점의 결정론"을 제공하는 역할 (출처: Scanner 설계 리뷰, 2026-03-09) (→ 글로벌 승격 완료, 2026-03-15)
...
- 설계 원칙이 합의되었을 때, 해당 분리가 이미 다른 형태로 달성되어 있는지 확인이 우선. 원칙의 실질적 달성과 문자적 해석의 구분이 과설계 방지의 핵심 (출처: 산출물 온톨로지 리뷰, 2026-03-09) (→ 글로벌 승격 완료, 2026-03-15)
